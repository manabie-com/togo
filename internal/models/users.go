...
type User struct {
	...
	MaxTodo  int    `boil:"max_todo" json:"max_todo" toml:"max_todo" yaml:"max_todo"`
...
var UserWhere = struct {
	...
	MaxTodo  whereHelperint
}{
	ID:       whereHelperstring{field: "\"manabie\".\"users\".\"id\""},
	Password: whereHelperstring{field: "\"manabie\".\"users\".\"password\""},
	MaxTodo:  whereHelperint{field: "\"manabie\".\"users\".\"max_todo\""},
}
...
var (
	userAllColumns            = []string{"id", "password", "max_todo"}
	userColumnsWithoutDefault = []string{"id", "password"}
	userColumnsWithDefault    = []string{"max_todo"}
...
func (o *User) Tasks(mods ...qm.QueryMod) taskQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"manabie\".\"tasks\".\"user_id\"=?", o.ID),
	)

	query := Tasks(queryMods...)
	queries.SetFrom(query.Query, "\"manabie\".\"tasks\"")

	if len(queries.GetSelect(query.Query)) == 0 {
		queries.SetSelect(query.Query, []string{"\"manabie\".\"tasks\".*"})
	}
...
func (userL) LoadTasks(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		qm.From(`manabie.tasks`),
		qm.WhereIn(`manabie.tasks.user_id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func Users(mods ...qm.QueryMod) userQuery {
	mods = append(mods, qm.From("\"manabie\".\"users\""))
...
func FindUser(ctx context.Context, exec boil.ContextExecutor, iD string, selectCols ...string) (*User, error) {
	...
	query := fmt.Sprintf(
		"select %s from \"manabie\".\"users\" where \"id\"=$1", sel,
	)
...
func (o *User) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	...
	if !cached {
		...
		if len(wl) != 0 {
			cache.query = fmt.Sprintf("INSERT INTO \"manabie\".\"users\" (\"%s\") %%sVALUES (%s)%%s", strings.Join(wl, "\",\""), strmangle.Placeholders(dialect.UseIndexPlaceholders, len(wl), 1, 1))
		} else {
			cache.query = "INSERT INTO \"manabie\".\"users\" %sDEFAULT VALUES%s"
		}
...
func (o *User) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		cache.query = fmt.Sprintf("UPDATE \"manabie\".\"users\" SET %s WHERE %s",
...
func (o UserSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	sql := fmt.Sprintf("UPDATE \"manabie\".\"users\" SET %s WHERE %s",
...
func (o *User) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	...
	if !cached {
		...
		cache.query = buildUpsertQueryPostgres(dialect, "\"manabie\".\"users\"", updateOnConflict, ret, update, conflict, insert)
...
func (o *User) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM \"manabie\".\"users\" WHERE \"id\"=$1"
...
func (o UserSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM \"manabie\".\"users\" WHERE " +
...
func (o *UserSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	sql := "SELECT \"manabie\".\"users\".* FROM \"manabie\".\"users\" WHERE " +
		strmangle.WhereClauseRepeated(string(dialect.LQ), string(dialect.RQ), 1, userPrimaryKeyColumns, len(*o))
...
func UserExists(ctx context.Context, exec boil.ContextExecutor, iD string) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"manabie\".\"users\" where \"id\"=$1 limit 1)"
