...
import (
	...
	storages "github.com/phuwn/togo/internal/storages"
)
...
func (_m *Store) AddTask(ctx context.Context, t *storages.Task) error {
	ret := _m.Called(ctx, t)
...
func (_m *Store) RetrieveTasks(ctx context.Context, userID sql.NullString, createdDate sql.NullString) ([]*storages.Task, error) {
...
func (_m *Store) ValidateUser(ctx context.Context, userID sql.NullString, pwd string) bool {
	ret := _m.Called(ctx, userID, pwd)

	var r0 bool
	if rf, ok := ret.Get(0).(func(context.Context, sql.NullString, string) bool); ok {
