...
import (
	...
	sqlc "github.com/dinhquockhanh/togo/internal/pkg/sql/sqlc"
...
func (m *MockQuerier) AssignTask(ctx context.Context, arg *sqlc.AssignTaskParams) (*sqlc.Task, error) {
	m.ctrl.T.Helper()
...
func (m *MockQuerier) CreateLimit(ctx context.Context, arg *sqlc.CreateLimitParams) (*sqlc.Limit, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateLimit", ctx, arg)
	ret0, _ := ret[0].(*sqlc.Limit)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockQuerier) CreateTier(ctx context.Context, arg *sqlc.CreateTierParams) (*sqlc.Tier, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateTier", ctx, arg)
	ret0, _ := ret[0].(*sqlc.Tier)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockQuerier) DeleteLimit(ctx context.Context, arg *sqlc.DeleteLimitParams) error {
	m.ctrl.T.Helper()
...
func (m *MockQuerier) GetLimit(ctx context.Context, arg *sqlc.GetLimitParams) (*sqlc.Limit, error) {
	m.ctrl.T.Helper()
...
func (m *MockQuerier) GetTask(ctx context.Context, id int32) (*sqlc.Task, error) {
	m.ctrl.T.Helper()
...
func (m *MockQuerier) GetTier(ctx context.Context, id int16) (*sqlc.Tier, error) {
	m.ctrl.T.Helper()
...
func (m *MockQuerier) GetUserByName(ctx context.Context, username string) (*sqlc.User, error) {
	m.ctrl.T.Helper()
...
func (m *MockQuerier) ListLimits(ctx context.Context, arg *sqlc.ListLimitsParams) ([]*sqlc.Limit, error) {
	m.ctrl.T.Helper()
...
func (m *MockQuerier) ListTiers(ctx context.Context, arg *sqlc.ListTiersParams) ([]*sqlc.Tier, error) {
	m.ctrl.T.Helper()
...
func (m *MockQuerier) UpdateUserTier(ctx context.Context, arg *sqlc.UpdateUserTierParams) (*sqlc.User, error) {
	m.ctrl.T.Helper()
