...
import com.todo.ws.user.service.CustomUserDetailsService;
...
public class UserControllerTests {
    ...
    public void accessPublicRegisterRouteOk() throws Exception {
        ...
        when(this.todoUserService.createUser(any(UserRegistrationDTO.class)))
            .thenReturn(new ResponseEntity<Boolean>(true, AuthenticationEnum.USER_CREATE_SUCCESSFUL.getContent()));
