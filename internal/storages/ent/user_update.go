...
func (uu *UserUpdate) SetMaxTodo(i int) *UserUpdate {
	uu.mutation.ResetMaxTodo()
	uu.mutation.SetMaxTodo(i)
	return uu
}

// SetNillableMaxTodo sets the "max_todo" field if the given value is not nil.
func (uu *UserUpdate) SetNillableMaxTodo(i *int) *UserUpdate {
	if i != nil {
		uu.SetMaxTodo(*i)
	}
	return uu
...
func (uu *UserUpdate) AddMaxTodo(i int) *UserUpdate {
	uu.mutation.AddMaxTodo(i)
	return uu
}
...
func (uu *UserUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := uu.mutation.MaxTodo(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
			Type:   field.TypeInt,
			Value:  value,
			Column: user.FieldMaxTodo,
		})
	}
	if value, ok := uu.mutation.AddedMaxTodo(); ok {
...
// SetMaxTodo sets the "max_todo" field.
func (uuo *UserUpdateOne) SetMaxTodo(i int) *UserUpdateOne {
	uuo.mutation.ResetMaxTodo()
	uuo.mutation.SetMaxTodo(i)
	return uuo
}

// SetNillableMaxTodo sets the "max_todo" field if the given value is not nil.
func (uuo *UserUpdateOne) SetNillableMaxTodo(i *int) *UserUpdateOne {
	if i != nil {
		uuo.SetMaxTodo(*i)
	}
	return uuo
...
// AddMaxTodo adds i to the "max_todo" field.
func (uuo *UserUpdateOne) AddMaxTodo(i int) *UserUpdateOne {
	uuo.mutation.AddMaxTodo(i)
	return uuo
}
...
func (uuo *UserUpdateOne) sqlSave(ctx context.Context) (_node *User, err error) {
	...
	if value, ok := uuo.mutation.MaxTodo(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
			Type:   field.TypeInt,
			Value:  value,
			Column: user.FieldMaxTodo,
	...
	if value, ok := uuo.mutation.AddedMaxTodo(); ok {
		_spec.Fields.Add = append(_spec.Fields.Add, &sqlgraph.FieldSpec{
			Type:   field.TypeInt,
			Value:  value,
			Column: user.FieldMaxTodo,
