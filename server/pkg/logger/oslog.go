...
var logger = log.New(os.Stderr, "logger: ", log.Llongfile)
...
func Debug(msg string) {
	logWithLevel(DebugLevel, msg)
}

func logfWithLevel(level, format string, v ...interface{}) {
	logger.Output(3, level + fmt.Sprintf(format, v...))
}
...
func Debugf(format string, v ...interface{}) {
	logfWithLevel(DebugLevel, format, v...)
}
