...
import com.todo.ws.user.application.dto.UserLoginDTO;
import com.todo.ws.user.application.dto.UserRegistrationDTO;
import com.todo.ws.user.service.TodoUserService;
import com.todo.ws.user.service.TokenProvider;
...
public class UserController {
    ...
    public ResponseEntity<Boolean> createUser(@RequestBody UserRegistrationDTO dto) {
        return this.todoUserService.createUser(dto);
    }

    @PostMapping(value = "/login", consumes="application/json", produces = "application/json")
    public ResponseEntity<String> authenticateUser(@RequestBody UserLoginDTO loginRequest) throws Exception {
