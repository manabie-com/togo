...
func TaskLimit(v int) predicate.User {
	return predicate.User(sql.FieldEQ(FieldTaskLimit, v))
}
...
func TaskLimitNEQ(v int) predicate.User {
	return predicate.User(sql.FieldNEQ(FieldTaskLimit, v))
}

// TaskLimitIn applies the In predicate on the "task_limit" field.
func TaskLimitIn(vs ...int) predicate.User {
	return predicate.User(sql.FieldIn(FieldTaskLimit, vs...))
}

// TaskLimitNotIn applies the NotIn predicate on the "task_limit" field.
func TaskLimitNotIn(vs ...int) predicate.User {
	return predicate.User(sql.FieldNotIn(FieldTaskLimit, vs...))
}

// TaskLimitGT applies the GT predicate on the "task_limit" field.
func TaskLimitGT(v int) predicate.User {
	return predicate.User(sql.FieldGT(FieldTaskLimit, v))
}

// TaskLimitGTE applies the GTE predicate on the "task_limit" field.
func TaskLimitGTE(v int) predicate.User {
	return predicate.User(sql.FieldGTE(FieldTaskLimit, v))
}

// TaskLimitLT applies the LT predicate on the "task_limit" field.
func TaskLimitLT(v int) predicate.User {
	return predicate.User(sql.FieldLT(FieldTaskLimit, v))
}

// TaskLimitLTE applies the LTE predicate on the "task_limit" field.
func TaskLimitLTE(v int) predicate.User {
	return predicate.User(sql.FieldLTE(FieldTaskLimit, v))
}

// HasUserTask applies the HasEdge predicate on the "user_task" edge.
func HasUserTask() predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.Edge(sqlgraph.O2M, false, UserTaskTable, UserTaskColumn),
		)
		sqlgraph.HasNeighbors(s, step)
	})
}

// HasUserTaskWith applies the HasEdge predicate on the "user_task" edge with a given conditions (other predicates).
func HasUserTaskWith(preds ...predicate.Task) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(UserTaskInverseTable, FieldID),
			sqlgraph.Edge(sqlgraph.O2M, false, UserTaskTable, UserTaskColumn),
		)
