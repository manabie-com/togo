...
public interface TodoRepositoryCustom {
     ...
     * Creates a new model.
     */
    Optional<Todo> create(Todo model);
     ...
     */
    Optional<Todo> update(Todo modelUpdate);
     ...
     * @return role details {@link Todo}
     */
    List<Todo> getAll(Pageable pageable);

    /**
     * Gets the list task by user.
     *
     * @return role details {@link Todo}
     */
    List<Todo> getTaskBy(String userID);
