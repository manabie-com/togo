...
var UserWhere = struct {
	...
	ID:        whereHelperint{field: "\"togo\".\"users\".\"id\""},
	Email:     whereHelpernull_String{field: "\"togo\".\"users\".\"email\""},
	Password:  whereHelperstring{field: "\"togo\".\"users\".\"password\""},
	Name:      whereHelperstring{field: "\"togo\".\"users\".\"name\""},
	Quota:     whereHelperint{field: "\"togo\".\"users\".\"quota\""},
	CreatedAt: whereHelpertime_Time{field: "\"togo\".\"users\".\"created_at\""},
	UpdatedAt: whereHelpertime_Time{field: "\"togo\".\"users\".\"updated_at\""},
	DeletedAt: whereHelpernull_Time{field: "\"togo\".\"users\".\"deleted_at\""},
}
...
var (
	userAllColumns            = []string{"id", "email", "password", "name", "quota", "created_at", "updated_at", "deleted_at"}
	userColumnsWithoutDefault = []string{"password", "name", "quota"}
...
func (o *User) Tasks(mods ...qm.QueryMod) taskQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"togo\".\"tasks\".\"user_id\"=?", o.ID),
	)
...
func (userL) LoadTasks(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		qm.From(`togo.tasks`),
		qm.WhereIn(`togo.tasks.user_id in ?`, args...),
		qmhelper.WhereIsNull(`togo.tasks.deleted_at`),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func Users(mods ...qm.QueryMod) userQuery {
	mods = append(mods, qm.From("\"togo\".\"users\""), qmhelper.WhereIsNull("\"togo\".\"users\".\"deleted_at\""))
	q := NewQuery(mods...)
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"\"togo\".\"users\".*"})
	}
...
func FindUser(ctx context.Context, exec boil.ContextExecutor, iD int, selectCols ...string) (*User, error) {
	...
	query := fmt.Sprintf(
		"select %s from \"togo\".\"users\" where \"id\"=$1 and \"deleted_at\" is null", sel,
	)
...
func (o *User) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	...
	if !cached {
		...
		if len(wl) != 0 {
			cache.query = fmt.Sprintf("INSERT INTO \"togo\".\"users\" (\"%s\") %%sVALUES (%s)%%s", strings.Join(wl, "\",\""), strmangle.Placeholders(dialect.UseIndexPlaceholders, len(wl), 1, 1))
		} else {
			cache.query = "INSERT INTO \"togo\".\"users\" %sDEFAULT VALUES%s"
		}
...
func (o *User) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		cache.query = fmt.Sprintf("UPDATE \"togo\".\"users\" SET %s WHERE %s",
...
func (o UserSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	sql := fmt.Sprintf("UPDATE \"togo\".\"users\" SET %s WHERE %s",
...
func (o *User) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	...
	if !cached {
		...
		cache.query = buildUpsertQueryPostgres(dialect, "\"togo\".\"users\"", updateOnConflict, ret, update, conflict, insert)
...
func (o *User) Delete(ctx context.Context, exec boil.ContextExecutor, hardDelete bool) (int64, error) {
	...
	if hardDelete {
		...
		sql = "DELETE FROM \"togo\".\"users\" WHERE \"id\"=$1"
	} else {
		currTime := time.Now().In(boil.GetLocation())
		o.DeletedAt = null.TimeFrom(currTime)
		wl := []string{"deleted_at"}
		sql = fmt.Sprintf("UPDATE \"togo\".\"users\" SET %s WHERE \"id\"=$2",
			strmangle.SetParamNames("\"", "\"", 1, wl),
		)
...
func (o UserSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor, hardDelete bool) (int64, error) {
	...
	if hardDelete {
		...
		sql = "DELETE FROM \"togo\".\"users\" WHERE " +
		...
		wl := []string{"deleted_at"}
		sql = fmt.Sprintf("UPDATE \"togo\".\"users\" SET %s WHERE "+
...
func (o *UserSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	sql := "SELECT \"togo\".\"users\".* FROM \"togo\".\"users\" WHERE " +
		strmangle.WhereClauseRepeated(string(dialect.LQ), string(dialect.RQ), 1, userPrimaryKeyColumns, len(*o)) +
...
func UserExists(ctx context.Context, exec boil.ContextExecutor, iD int) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"togo\".\"users\" where \"id\"=$1 and \"deleted_at\" is null limit 1)"
