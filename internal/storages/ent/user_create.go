...
func (uc *UserCreate) SetMaxTodo(i int) *UserCreate {
	uc.mutation.SetMaxTodo(i)
	return uc
}

// SetNillableMaxTodo sets the "max_todo" field if the given value is not nil.
func (uc *UserCreate) SetNillableMaxTodo(i *int) *UserCreate {
	if i != nil {
		uc.SetMaxTodo(*i)
	}
	return uc
...
func (uc *UserCreate) defaults() {
	if _, ok := uc.mutation.MaxTodo(); !ok {
		v := user.DefaultMaxTodo
		uc.mutation.SetMaxTodo(v)
	}
}
...
func (uc *UserCreate) check() error {
	...
	if _, ok := uc.mutation.MaxTodo(); !ok {
		return &ValidationError{Name: "max_todo", err: errors.New("ent: missing required field \"max_todo\"")}
	}
	return nil
}
...
func (uc *UserCreate) createSpec() (*User, *sqlgraph.CreateSpec) {
	...
	if value, ok := uc.mutation.MaxTodo(); ok {
		_spec.Fields = append(_spec.Fields, &sqlgraph.FieldSpec{
			Type:   field.TypeInt,
			Value:  value,
