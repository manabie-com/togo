...
// IAuthorApi is an autogenerated mock type for the IAuthorApi type
type IAuthorApi struct {
	mock.Mock
}
...
func (_m *IAuthorApi) Validate(req *http.Request) (context.Context, *tools.TodoError) {
	ret := _m.Called(req)
